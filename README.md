...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=3000&pause=1000&color=70A5FD&center=true&vCenter=true&width=750&lines=Vaishnavi+PM;Full-Stack+Developer+%7C+React+%2B+Laravel;Cloud+%26+AI%2FML+Enthusiast;Building+Real+Products+That+Matter)](https://git.io/typing-svg)
...
**B.Tech Information Technology · Chennai Institute of Technology · 2024–2028 · CGPA 8.2 / 10**

- Web Dev Intern at **Friendszion Technologies** — built 5+ live pages, integrated REST APIs
- ML model for thyroid disease detection — **94% accuracy**, F1: 0.91, 7,200 records
- Face recognition attendance system — **30 students clocked in under 10 seconds** using OpenCV
